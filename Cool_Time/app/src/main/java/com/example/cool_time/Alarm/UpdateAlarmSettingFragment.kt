...
class UpdateAlarmSettingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_update_alarm_setting, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment UpdateAlarmSettingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UpdateAlarmSettingFragment().apply {
